...
import { DaytaskPutComponent } from './daytask-put.component';
...
describe('DaytaskPutComponent', () => {
  let component: DaytaskPutComponent;
  let fixture: ComponentFixture<DaytaskPutComponent>;
  ...
  beforeEach(async () => {
    TestBed.configureTestingModule({
      ...
      declarations: [DaytaskPutComponent, CdkDropList],
      providers: [UserService, TaskService, { provide: ActivatedRoute, useValue: { params: of({ id: 123 }) } }]
    })
  });


  beforeEach(() => {
    TestBed.overrideComponent(DaytaskPutComponent, { set: { providers: [{ provide: TaskService, useClass: MockTaskService }, {provide: UserService,  useClass: MockUserService}]}});
    TestBed.compileComponents();
    fixture = TestBed.createComponent(DaytaskPutComponent);
